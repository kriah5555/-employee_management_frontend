...
export default function Table({ columns, rows, tableName, showDetails, viewAction, empId, parentId, height, setRows, SaveSalaries, multiPurpose }) {
    ...
    const actionIconsList = [
        rowData => ({
            ...
            hidden: (!rowData.parentOnly && tableName !== 'location' && tableName !== 'workstation' && tableName !== 'responsible_person' && tableName !== 'function' && tableName !== 'social_secretary' && tableName !== 'cost center' && tableName !== "email_template" && tableName !== 'contracts' && tableName !== "contract_template" && tableName !== 'employee' && tableName !== "open_shifts_overview" && tableName !== "applied_candidates" && tableName !== 'holiday_overview' && tableName !== 'documents_overview') ? false : true
        }),
        rowData => ({
            icon: () => getViewIcon(),
            tooltip: t("VIEW"),
        ...
        rowData => ({
            ...
            hidden: (!rowData.parentOnly && tableName !== 'employee' && tableName !== "email_template" && tableName !== 'holiday_overview' && tableName !== "applied_candidates" && tableName !== 'documents_overview') ? false : true
        }),
        rowData => ({
            icon: () => getAcceptIcon(),
            tooltip: 'Accept',
