    ...
    return (
        <div className="col-md-3 p-0 border-left">
                ...
                <div className="row m-0">
                    ...
                    <Legend title={t('DIMONA_MESSAGE_TITLE')} styleClass1={"col-md-5"} styleClass2={"box background-red"}></Legend>
                    <Legend title={t('INDII_MESSAGE_TITLE')} styleClass1={"col-md-6"} styleClass2={"box background-blue"}></Legend>
                </div>
