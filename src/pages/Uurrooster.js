                ...
                <div className="col-md-12 d-flex mt-4">
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="d-flex mt-1 border col-md-8 p-0 mx-auto">
                            <div className="button-style mr-5 mr-sm-2" onClick={() => setNextPrev('prev')}><img className="planning-icon" src={LeftArrowIcon}></img></div>
                            <p className="monthText mx-auto my-auto">{dayData}</p>
                            <div className="button-style ml-5 ml-sm-2" onClick={() => setNextPrev('next')}><img className="planning-icon" src={RightArrowIcon}></img></div>
                        </div>
                    </div>
